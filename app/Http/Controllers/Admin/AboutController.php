    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            $object->save();
             ...
             if ($request->logo) {
                 if($object->logo) {
                     FileHelper::deleteFileFromCloudflare($object->logo, $object->id, ThisModel::class, 'logo');
                 }
                 FileHelper::uploadFileToCloudflare($request->logo, $object->id, ThisModel::class, 'logo');
             }
